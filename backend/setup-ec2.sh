...
echo "🚀 Setting up rizz.money Backend on EC2..."
...
sudo cp nginx.conf /etc/nginx/conf.d/rizz.money-backend.conf
...
echo "   sudo nano /home/ec2-user/rizz.money-v1/backend/.env"
echo ""
echo "2. Start the application:"
echo "   cd /home/ec2-user/rizz.money-v1/backend"
