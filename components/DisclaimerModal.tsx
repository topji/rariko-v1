  ...
  return (
    ...
    >
      <motion.div
        ...
        className="w-full max-w-lg max-h-[70vh]"
      >
        <Card className="relative overflow-hidden bg-gradient-to-br from-gray-900 to-gray-800 border border-gray-700/50 flex flex-col max-h-[70vh]">
          {/* Header */}
          <div className="p-6 border-b border-gray-700/50 flex-shrink-0">
            ...
            <p className="text-gray-300 text-sm">
              Please read and accept the following terms before using rizz.money
            </p>
          </div>
